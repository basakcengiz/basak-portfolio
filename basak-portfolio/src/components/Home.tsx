...
const Home = () => {
  return (
    <div className="h-screen ">
      <div className="flex flex-col items-center justify-evenly sm:flex-row h-3/5 mt-20 gap-2">
        <div>
          <img src={bc} alt="bc" className="rounded-full w-56 h-72 border-[#b1b1b1] border-2 hover:scale-125 duration-300 ease-in-out" />
        </div>
