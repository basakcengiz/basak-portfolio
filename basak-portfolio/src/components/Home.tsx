   ...
   return (
      <div className="h-screen ">
         <div className="flex flex-col items-center gap-2 mt-20 justify-evenly sm:flex-row h-3/5">
            <div>
               <img src={bc} alt="bc" className="rounded-full w-68 max-h-96 border-[#b1b1b1] border-2 md:hover:scale-110 duration-300 ease-in-out" />
            </div>
               ...
               <div className="flex flex-col items-center justify-center gap-6">
                  ...
                  <div className="flex items-center justify-center w-1/3 h-8">
                     <a
                        ...
                        className="flex items-center justify-center w-full h-full text-white rounded-full bg-sky-400"
                     >
                        View CV
                     </a>
                  </div>
